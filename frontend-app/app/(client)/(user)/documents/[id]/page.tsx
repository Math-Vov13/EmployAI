...
import { formatFileSize, getFileTypeName } from '@/app/lib/storage/file-validation';
        ...
        <Card>
          ...
          <CardBody className="px-6 pb-6">
            ...
            <div className="mb-6 bg-gray-50 p-4 rounded-lg">
              <h3 className="text-sm font-semibold text-gray-600 mb-3">File Information</h3>
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="font-medium">{getFileTypeName(document.mimeType)}</p>
                </div>
                <div>
            ...
            {/* Uploaded By */}
            <div className="mb-6">
              <h3 className="text-sm font-semibold text-gray-600 mb-2">Uploaded By</h3>
